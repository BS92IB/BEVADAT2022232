...
#Néhány split-depth pár amikkel 78% körüli accuracy érhető el.
#Észrevétel: A split értéke nem befolyásolja az eredményt.
#A legpontosabb eredmény a depth növelésével érhető el.
#A depth növelésékor errorokra futottam.
#A depth növelésével egyre tovább tartott lefutnia a modelnek.

#Először kicsit bonyolultnak tűnt a feladat, de jobban belegondolva miután megértettem jobb volt mint az eddigi házik.
